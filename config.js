...
global.gurl = 'https://instagram.com/4.4.4.4.4.4.4444?igshid=YzU1NGVlODEzOA==' // add your username
...
module.exports = {
  ...
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '𝙰𝙽𝙰𝙽𝙳𝙷𝚄444' : process.env.PACK_INFO.split(";")[0],
